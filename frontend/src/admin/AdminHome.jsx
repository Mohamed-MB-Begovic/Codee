...
if (
  ...
  (user.role === 'admin' && user.status !== 'active') || // admin but not active
  ...
  const navigation = [
    ...
    { name: 'Elections', path: '/admin/elections', icon: DocumentTextIcon },
    { name: 'Users', path: '/admin/users', icon: AcademicCapIcon },
    {name: 'settings', path: '/admin/settings', icon: Cog6ToothIcon}
  ];

  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden"> {/* Added overflow-hidden to prevent body scroll */}
      ...
      >
        ...
        <div className="flex flex-col h-full justify-between overflow-hidden">
          <nav className="mt-4 flex-1 px-2 overflow-y-auto"> {/* Added overflow-y-auto for sidebar nav only */}
          ...
          <div className="px-4 py-4 border-t border-gray-700 flex-shrink-0">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs font-medium text-gray-400">{user?.role || 'administrator'}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Main content area */}
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden"> {/* Added min-w-0 and overflow-hidden */}
        {/* Header - Fixed height */}
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-gray-50"> {/* Added bg-gray-50 for better visual separation */}
          <Outlet/>
        </main>
      </div>
